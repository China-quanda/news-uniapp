...
const api_articleCategory = require("../api/articleCategory.js");
const useArticleCtegoryStore = common_vendor.defineStore("articleCtegoryStore", {
  unistorage: {
  ...
  actions: {
    loadArticleCtegoryList() {
      return new Promise((resolve, reject) => {
        ...
        api_articleCategory.getArticleCtegoryList({ pageSize: 100 }).then((res) => {
...
exports.useArticleCtegoryStore = useArticleCtegoryStore;
