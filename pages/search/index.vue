<template>
	<view class="search-page">
		<my-nav-bar v-if="true" rightText="搜索" :clickLeft="handleBack" :clickRight="loadArticleList" leftWidth="60rpx"
			rightWidth="70rpx">
			<view class="input-view">
				<uni-icons type="search" size="18" color="#999" />
				<uni-easyinput class="nav-bar-input" v-model="searchArticleQuery.keywords" placeholder="请输入关键词进行搜索"
					:inputBorder="false" focus confirm-type="search" type="text" trim="both" @confirm="loadArticleList" />
			</view>
		</my-nav-bar>
		<view class="content">
			<!-- 联想建议 -->
			<search-advice v-show="showAdvice" :keyword="searchKeyword" :list="searchAdviceList" @onClick="tapAdvice" />
			<!-- history -->
