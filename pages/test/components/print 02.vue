...
export default {
	...
	methods: {
		...
		print() {
			...
			command.setText(l, 170, 'TSS24.BF2', 1, 1, '收费日期: 2023-06-22');
			
			command.setText(l, 210, 'TSS24.BF2', 1, 1, '收费类别:2019居民用水价格');
			
			command.setText(l, 250, 'TSS24.BF2', 1, 1, '年度用水:3.5');
			
			command.setText(l, 290, 'TSS24.BF2', 1, 1, '费用项 | 月份 | 抄表读数 | 用量 | 单价 | 金额');
			
			command.setText(l, 330, 'TSS24.BF2', 1, 1, '污水费 |  |  65-69 | 3.50 | 0.80 | 2.80');
			
			command.setText(l, 370, 'TSS24.BF2', 1, 1, '自来水水费 |  |  65-69 | 3.50 | 3.80 | 13.30');
			
			command.setText(l, 410, 'TSS24.BF2', 1, 1, '上次余额:13.24');
			command.setText(r, 410, 'TSS24.BF2', 1, 1, '应缴金额:16.10');
			
			command.setText(l, 450, 'TSS24.BF2', 1, 1, '本次余额:0.14');
			command.setText(r, 450, 'TSS24.BF2', 1, 1, '实收余额:3.00');
			
			command.setText(l, 490, 'TSS24.BF2', 1, 1, '大写金额:叁元整');
			command.setText(r, 490, 'TSS24.BF2', 1, 1, '小写合计:3.00');
			
			command.setText(l, 530, 'TSS24.BF2', 1, 1, '收费员:超级管理员');
			...
			command.setText(l, 910, 'TSS24.BF2', 1, 1, '收费日期: 2023-06-22');
			
			command.setText(l, 950, 'TSS24.BF2', 1, 1, '收费类别:2019居民用水价格');
			
			command.setText(l, 990, 'TSS24.BF2', 1, 1, '年度用水:3.5');
			
			command.setText(l, 1030, 'TSS24.BF2', 1, 1, '费用项 | 月份 | 抄表读数 | 用量 | 单价 | 金额');
			
			command.setText(l, 1070, 'TSS24.BF2', 1, 1, '污水费 |  |  65-69 | 3.50 | 0.80 | 2.80');
			
			command.setText(l, 1110, 'TSS24.BF2', 1, 1, '自来水水费 |  |  65-69 | 3.50 | 3.80 | 13.30');
			
			command.setText(l, 1150, 'TSS24.BF2', 1, 1, '上次余额:13.24');
			command.setText(r, 1150, 'TSS24.BF2', 1, 1, '应缴金额:16.10');
			
			command.setText(l, 1190, 'TSS24.BF2', 1, 1, '本次余额:0.14');
			command.setText(r, 1190, 'TSS24.BF2', 1, 1, '实收余额:3.00');
			
			command.setText(l, 1230, 'TSS24.BF2', 1, 1, '大写金额:叁元整');
			command.setText(r, 1230, 'TSS24.BF2', 1, 1, '小写合计:3.00');
			
			command.setText(l, 1270, 'TSS24.BF2', 1, 1, '收费员:超级管理员');
