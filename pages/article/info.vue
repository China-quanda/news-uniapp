	...
	<view class="wrap">
		...
		<my-nav-bar rightText="搜索" :clickLeft="clickLeft" leftWidth="60rpx" rightWidth="120rpx">
			<view class="nav-view">
				...
				<view v-else class="article-title"><text>webpack2 + vue2 老项目迁移 vite 成功! 是真香啊webpack2 + vue2 老项目迁移 vite 成功! 是真香啊</text></view>
			</view>
			<block v-slot:right>
				<view>
			...
			<view class="article-content" ref="articleContent">
				...
				<view class="author" ref="author" v-if="article.user">
					<view class="author-left" @tap="goToUser(article.user_id)">
						<view class="author-avatar"><!-- <u-avatar :src="article.user.avatar"  size="36"></u-avatar> --></view>
					...
					<view class="author-right"><!-- <u-button size="small" type="primary" @tap="onClickFocus(article.user_id)">{{isAttentionAuthor ? '已关注':'+关注'}}</u-button> --></view>
				</view>
				<!-- 文章描述 -->
