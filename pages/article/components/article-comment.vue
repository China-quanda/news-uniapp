<template>
	<uni-popup ref="popupRef" type="bottom"  @change="popupChange">
		<view class="article-comment" :class="{'fullScreen':isFullScreen}" ref="comment">
			...
			<view class="comment-item" v-for="item in 1" :key="item">
				<view class="comment-left"><my-avatar src="https://fastly.jsdelivr.net/npm/@vant/assets/cat2s2.jpeg"
						width="36px" height="36px" /></view>
				<view class="comment-right">
					...
					<view class="footer">
						...
						<view class="right-action">
							...
							<my-text class="like" bold text="44" prefixIcon="icon-dianzan" size="12" iconSize="14"
								@tap="ontapLike(item.id)" />
						</view>
					</view>
					...
					<view class="reply" v-for="i in 1" :key="i" v-if="true">
						<view class="comment-left"><my-avatar src="https://fastly.jsdelivr.net/npm/@vant/assets/cat2s2.jpeg"
								iconSize="16" ic width="26px" height="26px" /></view>
						<view class="comment-right">
							<view class="header"><my-text bold text="你的Maya" size="13" /></view>
							<view class="comment" @tap="ontapHuifu(item)">
								<my-text text="你的英雄难过美人关,你的英雄难过美人关,你的英雄难过美人关,你的英雄难过美人关,你的英雄难过美人关" size="13" />
					...
					<view class="more">
						...
						<my-text class="more-icon more-text" size="12" iconSize="14" text="展开3条回复" suffixIcon="icon-xiala"
							@tap="ontapLike(item.id)" />
						<my-text class="more-icon more-text" size="12" iconSize="14" text="展开更多回复" suffixIcon="icon-xiala"
							@tap="ontapLike(item.id)" />
						<my-text class="more-icon" size="12" iconSize="14" text="收起" suffixIcon="icon-xiangshang"
							@tap="ontapLike(item.id)" />
					</view>
				</view>
			</view>
			...
			<view class="send-comment" v-if="showSendComment">
				<textarea class="textarea" v-model="commentContent" :placeholder="commentPlaceholder" auto-focus auto-height
					fixed auto-blur :cursor-spacing="80" @focus="onSendKeyboard" @blur="onSendKeyboard"
