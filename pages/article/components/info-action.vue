<template>
  <view class='info-action'>
    ...
    <view class="info-action-row" @tap="ontapComment">
     ...
     <view class="info-action-row" @tap="ontapLike">
		 ...
		 <view class="info-action-row" @tap="ontapShare">
